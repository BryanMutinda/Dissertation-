...
==========================================================================================================*/
    ...
    // Resection & reprojection
    auto output = resectionAndReprojection(imageFiles, kMatrix, cameraDistortion);

    for (auto rotationFunction : output.first){
        std::cout << rotationFunction << "\n";
    };

    for (auto translationFunction : output.second){
        std::cout << translationFunction << "\n";
    };
